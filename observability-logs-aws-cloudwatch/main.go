...
import (
	...
	app "github.com/openchoreo/community-modules/observability-logs-aws-cloudwatch/internal"
	"github.com/openchoreo/community-modules/observability-logs-aws-cloudwatch/internal/cloudwatch"
	"github.com/openchoreo/community-modules/observability-logs-aws-cloudwatch/internal/observer"
)
...
func main() {
	...
	logger.Info("Configuration loaded",
		...
		slog.String("eventsLogGroupName", cfg.EventsLogGroupName),
